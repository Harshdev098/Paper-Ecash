...
export const setErrorWithTimeout = (payload: {type:string,message:string}) => (dispatch: AppDispatch) => {
...
export const setWarnWithTimeout = (payload: {type:string,message:string}) => (dispatch: AppDispatch) => {
